...
export type CloseInput<
  ...
  TAccountDapp extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountDapp>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountDapp> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.dapp),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountDapp>;
