...
- A basic Dapp Solana program written in Anchor
- [codama](https://github.com/codama-idl/codama) to generate a JS sdk for the program
- UI components for interacting with the Dapp program using the Anchor generated client
...
```shell
npx create-solana-dapp@latest -t gh:solana-foundation/templates/gill/dapp
```
...
the constant in the `anchor/src/dapp-exports.ts` file.
